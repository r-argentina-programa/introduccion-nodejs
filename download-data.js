...
if (process.env.API_FOOTBALL_DATA.length === 0) {
  console.log('Se debe crear un archivo.env (copiar el .env.dist y cambiarle el nombre) y configurar la API key gratuita de https://www.football-data.org/');
  process.exit(1);
}
...
async function iniciar() {
  const DIRECTORIO = './template-engine/data';
